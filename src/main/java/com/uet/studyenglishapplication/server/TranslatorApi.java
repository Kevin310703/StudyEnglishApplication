package com.uet.studyenglishapplication.server;
...
public class TranslatorApi {
    ...
    private static String translate(String langFrom, String langTo, String text)
            throws IOException {
        String urlStr =
                "https://script.google.com/macros/s/AKfycbxMINfQGeDN6UsKGalqzidSw5DC6ogamv9-DpdorCO3aeJAh4-8KrhfK1xYI43YHuWjeQ/exec"
                        + "?q="
